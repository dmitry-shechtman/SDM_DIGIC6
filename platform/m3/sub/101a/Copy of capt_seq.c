...
// "     BL    shooting_set_flash_override\n"// no sound pre and main fire.
"loc_fc0bd998:\n"
// "     BL    shooting_set_flash_override\n" // pre and main off
"       b       loc_fc0bdb28\n"
"loc_fc0bd99a:\n" // case 1: (normal shoot)
//"     BL    shooting_set_flash_override\n"  // before pre,both fire
"       ldr     r0, [r0,#0x10]\n"
"       bl      sub_fc0dae40_my\n" // ->  nr?, remote hook, raw hook
//"     BL    shooting_set_flash_override\n" // pre and main fire, sound after shot.No flash for second onwards.
"       b       loc_fc0bdb28\n"
"loc_fc0bd9a2:\n"
//"     BL    shooting_set_flash_override\n" // no sound, both fire.
"       movs    r0, #1\n"
...
"       bne     loc_fc0daf82\n"
"loc_fc0daf22:\n"
//"     BL    shooting_set_flash_override\n" // before preflash, pre and main both fire
"       mov     r0, r5\n"
"       bl      sub_fc11083e\n"
"       mov     r4, r0\n"
"       lsls    r0, r0, #0x1f\n"
...
// "     BL    shooting_set_flash_override\n" // pre main all shots, sound with/after pre
"       ldr     r6, =0xfc11d6f9\n"
"       mov     r5, r0\n"
"       bl      sub_fc18ab0a\n"
"       bl      sub_fc0db464\n"
...
"       bl      sub_fc0db046\n"
"loc_fc11d74c:\n"
//"     BL    shooting_set_flash_override\n" // pre and main fire, sound with/after pre
"       movs    r2, #4\n"
"       movw    r0, #0x137\n"
"       add     r1, sp, #4\n"
"       bl      sub_fc373498\n"

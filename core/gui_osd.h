...
#define ZOOM_SHOW_FOV                   3
#define ZOOM_SHOW_STEP                  4
//-------------------------------------------------------------------
...
extern void gui_osd_draw_big_zoom();
extern void gui_osd_draw_state();
extern void gui_osd_draw_values();
extern void gui_osd_draw_clock();
extern int  gui_osd_draw_zebra();
extern void gui_osd_draw_sio();
extern void gui_osd_draw_stereo();
extern long get_sensor_width();
float get_hyperfocal();
//-------------------------------------------------------------------
#endif
